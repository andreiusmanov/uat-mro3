...
public class OrganizationUnitsView2 extends VerticalLayout {
    ...
    public OrganizationUnitsView2(OrganizationService service, OrganizationUnit organization) {
    ...
    private void dialog() {
        this.dialog = new OrganizationUnitDialog(service, organization);
